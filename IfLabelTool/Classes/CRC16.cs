...
{
    /* Class for handling CRC16 reading and construction for sending.
     * ToDO: CRC16 construction
     * 
     */
    class CRC16
    {
        ...
        public CRC16(SystemLogFile slf)
        {
        ...
        //{
            ...
            public string ComputeCrc(byte[] data)
            {
                ushort crc = 0xFFFF;
                string hibyt="";
                int i = 0;
                ...
                {
                    hibyt += byt.ToString("X");
                    if (i < 1) this.HighByte = hibyt;
                    else this.LowByte = hibyt;
                }
                return hibyt;
            }
        //}
